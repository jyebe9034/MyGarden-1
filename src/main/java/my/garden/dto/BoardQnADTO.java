...
public class BoardQnADTO {
	...
	public BoardQnADTO(int bq_p_no, int bq_no, String bq_title, String bq_writer, String bq_content,
			Timestamp bq_writedate, String bq_imagepath1, String bq_imagepath2, String bq_imagepath3) {
