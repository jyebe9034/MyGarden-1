...
<!-- style -->
	<style>
		...
		#goToTop{position:fixed; right:28px; bottom:28px; border-radius:50%; padding:2px; box-shadow:1px 1px 5px 1px #444; z-index:999; font-size:15px; cursor:pointer; animation-duration:2s; animation-delay:2s;}
		...
		.topMenuNavbar{background-color:rgba(255,255,255,0.1); font-size:14px; font-weight:bold; /*text-shadow: 1px 1px 1px #999;*/}
			...
			.menuPosition-fixed{position:fixed; top:0; left:0; background:#f5f5f5;}
