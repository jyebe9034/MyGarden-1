...
<div class="container-fluid footer p-4 mt-5 text-center my">
	<div class="row m-auto">
		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 m-auto my">
			<div class="row m-auto">
				<div class="col-lg-6 col-md-5 col-sm-6 col-xs-6 text-center text-shadow m-auto p-2 footerContactBox my">
					<h4 class="font-weight-bold">고객센터</h4>
					<h5 class="font-weight-bold">1588-0000</h5>
				</div>
				<div class="col-lg-6 col-md-7 col-sm-6 col-xs-6 mt-4 mb-2 text-center text-shadow my">
