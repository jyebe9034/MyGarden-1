	...
	<div class="container-fluid footer p-4 mt-5 text-center my">
		<div class="row m-auto">
			<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 m-auto my">
				<div class="row m-auto">
					<div
						class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-center text-shadow m-auto p-2 footerContactBox my">
						<h4 class="font-weight-bold">고객센터</h4>
						<h4 class="font-weight-bold">1588-0000</h4>
					</div>
					<div
						class="col-lg-6 col-md-6 col-sm-6 col-xs-6 mt-4 mb-2 text-center text-shadow my">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 m-1 footerEnd my">
				<span><a href="#">인재채용</a></span> <span><a href="#">이용약관</a></span>
				<span><a href="#">개인정보처리방침</a></span> <span><a href="#">이용안내</a></span>
				...
				<li>사업자등록번호:419-76-12257 <a href="#">[사업자정보확인]</a> |
					통신판매업신고:제2019-서울종로-0049호
				</li>
				<li>서울 종로구 청계천로 419-92 | T. 02-123-4567 | info@greeners.co.kr |
					개인정보관리자:김경성 | ©2019 GREENERS ALL RIGHTS RESERVED.</li>
			</div>
		</div>
	</div>