									...
									<tbody>
										<c:forEach var="dto" items="${list}">
											...
											<tr class="bottom_line">
												...
												<td class="cell"><span class="goods_input">2019-07-13</span>
												</td>
								...
								<table width="100%" border="0" cellpadding="10" cellspacing="0">
									...
									<tr>
										...
										<td valign="top" bgcolor="#878787" style="padding: 10px;">
											<table width="100%" border="0" cellpadding="0"
												cellspacing="0" class="white fx12">
												<col width="50%" />
												<col />
												<tr>
													<td>총 상품금액</td>
								...
								<div id="fee_benefit"
									...
									<div id="fee_benefit_head">
										<div style="font-size: 12px;">
											...
											추가 주문의 경우 별도로 박스포장 되어 출고 됩니다. <span
												...
												<table width="100%" border="0" cellpadding="0"
													...
													<tr>
														...
														<td class="fx12"><input type="text"
															id="order_user_name" value="${loginDTO.m_name }"
															size="15" /></td>
													</tr>
													<tr>
														<td height="8"></td>
													...
													<tr>
														...
														<td class="fx12"><input type="text"
															name="order_email" value="${loginDTO.m_email }" size="30" /></td>
													</tr>
													<tr>
														<td height="8"></td>
													</tr>
