					...
					<tr>
						...
						<td>
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0"
								...
								<tbody>
									<c:forEach var="dto" items="${list}">
										<c:set var="count"
											value="${count + dto.s_p_price*dto.s_p_count}" />
										<tr>
											...
											<td class="cell rline">${dto.s_p_count }</td>
											<td class="cell right"><fmt:formatNumber
														value="${dto.s_p_price }" type="number" /></td>
											<td class="cell right"><fmt:formatNumber
														value="${dto.s_p_count*dto.s_p_price*0.05 }" type="number" /></td>
									...
									<td valign="top" style="padding: 10px;">
										<table width="100%" border="0" cellpadding="0" cellspacing="0"
											...
											<tr>
												<td>총 적립금</td>
												<td align="right" class="fx12"><fmt:formatNumber
														value="${count*0.05 }" type="number" /> 원</td>
											</tr>
											<tr>
												<td height="8"></td>
											</tr>
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								...
								<tr>
									<td>받는사람</td>
									<td class="fx12">${orderDTO.s_m_recipient }</td>
								</tr>
								<tr>
									<td height="15"></td>
								</tr>
								<tr>
									<td>연락처</td>
									<td class="fx12">${orderDTO.s_phone }</td>
								</tr>
								<tr>
									<td height="15"></td>
								</tr>
								<tr class="goods_delivery_info">
									...
									<td class="fx12"><span style="font-weight: bold;">(지번
											주소)</span> ${orderDTO.s_m_zipcode } ${orderDTO.s_m_address1 }
										${orderDTO.s_m_address2 }</td>
								</tr>
								<tr class="goods_delivery_info">
									<td height="15"></td>
								</tr>
								...
								<tr>
									<td>이메일</td>
									<td class="fx12">${orderDTO.s_email }</td>
								</tr>
								<tr>
									<td height="15"></td>
								</tr>
								<tr class="goods_delivery_info">
									<td>배송메세지</td>
									<td class="fx12">${orderDTO.s_m_memo }</td>
								</tr>
								<tr class="goods_delivery_info">
									<td height="20px;"></td>
									<td></td>
								...
								<tr>
									<td>
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="0">
											...
											<tr>
												<td>결제방식</td>
												<td class="fx12">${orderDTO.s_m_paymethod }</td>
											</tr>
											<c:if test="${orderDTO.s_m_paymethod=='무통장 입금'}">
												<tr>
													<td height="15"></td>
												</tr>
												<tr>
											...
											<tr>
												...
												<td class="fx12"><font color="black"><strong><fmt:formatNumber
														value="${count }" type="number" /> 원</strong></font></td>
											</tr>
											<tr>
												<td height="15"></td>
											</tr>
								...
								<tr>
									...
									<td width="300" align="right"><a href="productsList"
										...
										style="color: #fff; font-size: 14px; text-align: center;"><div
												...
												계속하기</div></a> <a href="orderList" id="orderList"
										style="color: #fff; font-size: 14px; text-align: center;"><div
												style="width: 138px; height: 45px; background: #636666; display: table-cell; vertical-align: middle;">주문
												목록</div></a></td>
								</tr>
